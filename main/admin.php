                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <form id="add_admin" method="POST" onsubmit="return add_admin()">

                                    <div class="row mb-3">
                                        <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">First Name</label>
                                        <div class="col-sm-10">
                                        <input type="text" name="admin_fname" class="form-control" id="exampleFormControlInput1">
                                    </div>

                                    <div class="row mb-3">
                                        <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Last Name</label>
                                        <div class="col-sm-10">
                                        <input type="text" name="admin_lname" class="form-control" id="exampleFormControlInput1">
                                    </div>

                                    <div class="row mb-3">
                                        <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Phone Number</label>
                                        <div class="col-sm-10">
                                        <input type="text" name="admin_notel" class="form-control" id="exampleFormControlInput1">
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label">Password</label>
                                        <div class="col-sm-10">
                                        <input type="password" name="admin_password" class="form-control" id="inputPassword3">
                                        </div>
                                    </div>
